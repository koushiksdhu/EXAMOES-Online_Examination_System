            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        <li><a href="Dachboard.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Dashboard</p></a></li>
                    ...
                    <div class="row col-md-12">
                        <div class="col-md-6">
                                           ...
                                           <tbody>
                                               <tr>
											     ...
											     <tr>
                                                   <th scope="row">2</th>
                                                   <td>Student Name</td>
                                                   <td><?php echo "$myfname $mylname"; ?></td>  <!--this data comes from check_user page-->
                                               </tr>
											    <tr>
                                                   <th scope="row">3</th>
                                                   <td>Marks</td>
                           ...
                           <div class="col-md-6">
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Result Status</h3>
                                </div>
                                <div class="panel-body">
                                <?php
								if ($status == "PASS") {
