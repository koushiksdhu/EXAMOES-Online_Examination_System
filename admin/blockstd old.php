                                        ...
                                        <tbody>';
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <td>'.$row['roll'].'</td>
                                                <td>'.$row['user_id'].'</td>
                                                <td><button type="button" class="btn btn-success" aria-expanded="false"><a'; ?> <?php print ' href="pages/enable.php?sd='.$row['user_id'].'">Block</a></button>
                                                
                                                
                                                <button type="button" class="btn btn-danger" aria-expanded="false"><a'; ?> <?php print ' href="pages/disable.php?sd='.$row['user_id'].'">Unblock</a></button></td>
                                                </ul>
                                                <td>'.$row['acc_stat'].'</td>
