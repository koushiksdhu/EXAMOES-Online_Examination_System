                                        ...
                                        <tbody>';
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <button type="button" class="btn btn-primary" aria-expanded="false"><a';?> onclick = "return confirm(' Are You Sure You Want To Delete the Notice ?')" <?php print ' href="pages/drop_notice.php?id='.$row['notice'].'">Delete</a></button></td>
