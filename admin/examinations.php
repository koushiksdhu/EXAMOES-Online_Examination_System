                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        ...
                                        <tbody>';
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <td>'.$row['subject'].'</td>
                                                <td>'.$row['date'].'</td>
                                                <td><button type="button" class="btn btn-success" aria-expanded="false"><a'; ?> <?php print ' href="pages/make_ex_ac.php?id='.$row['exam_id'].'">Start</a></button>
                                                <button type="button" class="btn btn-danger" aria-expanded="false"><a'; ?> <?php print ' href="pages/make_ex_in.php?id='.$row['exam_id'].'">Stop</a></button></td>
                                                <td>'.$row['status'].'</td>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li><a'; ?><?php print ' href="pages/drop_ex.php?id='.$row['exam_id'].'">Delete</a></li>
                                                </ul>
										...
										<div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Enter Full marks for this subject examination" name="fmarks" required autocomplete="off">
                                        </div>
									<div class="form-group">
                                    <label >Exam Date</label>
                                    <input type="text" class="form-control date-picker" name="date" required autocomplete="off" placeholder="Select Exam Date">
                                    </div>
										<div class="form-group">
