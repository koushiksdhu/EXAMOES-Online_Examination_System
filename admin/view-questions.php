                                    ...
                                    <div class="panel-body">
                                        <div class="tabs-below" role="tabpanel">
											...
											<div role="tabpanel" class="tab-content" id="tab'.$qno.'">
											 ...
											 <a';?> onclick = "return confirm('Delete this question ?')" <?php print 'class="btn btn-youtube m-b-xs"href="pages/drop_question.php?id='.$row['question_id'].'&eid='.$exam_id.'">Delete Question <i class="fa fa-trash-o"></i></a>
											...
											if ($qno == "1") {
                                                ...
                                                print '
                                                <div role="tabpanel" class="tab-content" id="tab'.$qno.'">
                                                <p style="font-size:17px;"><b>Question '.$qno.'.</b> '.$qs.'</p>
                                                ...
                                                <p style="font-size:15px;"><b> Answer : '.$answer.'</b></p>
                                                 ...
                                                 <a';?> onclick = "return confirm(' Are You Sure to Delete question no. <?php echo "$qno"?> ?'')" <?php print 'class="btn btn-youtube m-b-xs"href="pages/drop_question.php?id='.$row['question_id'].'&eid='.$exam_id.'">Delete Qno.'.$qno.'<i class="fa fa-trash-o"></i></a>
                                                 <hr>
                                                 </div>
                                                ';	
                                                }else{
