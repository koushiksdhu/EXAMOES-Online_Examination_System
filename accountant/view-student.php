...
if ($result->num_rows > 0) {
	...
	$qrcodetxt = 'ID:'.$student_id.', NAME: '.$sdfname.' '.$sdlname.', GENDER: '.$sdgender.', ay : '.$sday.', class : '.$sdclass.', section : '.$sdsection.', roll : '.$sdroll.'';
									...
									<table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">4.</th>
                                                <td>Section</td>
                                                <td><b><?php echo "$sdsection"; ?></b></td>
                                               
                                            </tr>
                                            <tr>
                                                <th scope="row">5.</th>
                                                <td>Roll No.</td>
                                                <td><b><?php echo "$sdroll"; ?></b></td>
											...
											<tr>
                                                <th scope="row">9.</th>
                                                <td>Address</td>
                                                <td colspan="2"><b><?php echo "$sdaddress"; ?></b></td>
